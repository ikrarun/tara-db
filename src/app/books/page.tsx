...
export default async function Home() {
  ...
  if(data!=null){
   return (
     <div className="max-w-[900px] mx-auto w-full flex flex-col gap-4 items-center justify-center">
       {/* title */}
       ...
       <h1 className="text-sm text-gray-500">Book&apos;s are suggested by the contributors.</h1>
       {/* content */}
       <div className="grid w-full grid-cols-1  place-items-center sm:grid-cols-2 gap-3 p-1">
         {data.map((book, index) => (
           <BookCard
             single={false}
